...
public class LipunVaraus{
	...
	public static void main(String[] args){ 
		...
		while(true){
			...
			System.out.println("\nJos haluat katsoa elokuvalistaa, syötä 1");
	 		System.out.println("Jos haluat tehdä varaus, syötä 2");
	 		System.out.println("Jos haluat lopeta, syötä 3");
	 		try{
	 			int choice = scan.nextInt(); 
	 			if (choice <  0 || choice > 3){
	 				System.out.println("Syöte pitäisi olla 1, 2 tai 3. Yritä uudelleen");
	 						continue;
	 			}
	 			else if (choice == 1){
	 ...
	 * */ 
	 ...
	 public static String paivaValitus(){ 
		System.out.println("Hei! Milloin haluat katsoa elokuvaa? \n \nValitse päivä syötämällä sen nimi tai index. Syötä 0, jos haluat lopettaa");
		...
		//	scan = new Scanner(System.in);	
			...
			int s = scan.nextInt();  
				...
				System.out.println("Olen valinnut päivä: " + viikonpaiva + ". Nyt valitse elokuva: \n");
